...
if __name__ == "__main__":
	...
	token_client_return = token_gestion.token_gestion_client(KEYCLOAK_BASE, REALM, CLIENT_ID, GRANT_TYPE, USERNAME, PASSWORD, CLIENT_SECRET ,TIMEOUT_TIME , VERIF_SSL)
	...
	GROUP = "TOTOPUPU"
	VERIF_SSL = False
	group_gestion.ydg_group_creation2(token_client_access_token,YDG_BASE, TENANT,USER_ID,GROUP,VERIF_SSL)
