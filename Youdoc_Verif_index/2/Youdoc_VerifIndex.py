...
if __name__ == "__main__":
    ...
    db_query_top = f"SELECT TOP ({Lot_fold}) {DB_name_fold} FROM [{DB_database}].[dbo].[{DB_data_fold}] WITH (NOLOCK) WHERE STATUS = '' "
            ...
            try :
                ...
                if retour["error"] :
                    ...
                    for doc in ids:
                        ...
                        db_query = f"INSERT INTO [{DB_database}].[dbo].[{DB_data_doc}] ({DB_name_doc},DD1RA) VALUES ('{id_value}','I')"
                ...
                if retour["error"] :
                    db_query = f"update [{DB_database}].[dbo].[{DB_data_fold}] set STATUS = 'N' Where {DB_name_fold} = '{row.EZBUNU}' "
                else : 
                    db_query = f"update [{DB_database}].[dbo].[{DB_data_fold}] set STATUS = 'I' Where {DB_name_fold} = '{row.EZBUNU}' "
