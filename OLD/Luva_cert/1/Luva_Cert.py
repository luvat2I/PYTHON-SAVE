...
terme = "luva"
contient_luva = terme.lower() in ini_filename.lower()
# ferme lapp
if not contient_luva:
	log_secure("0","ERROR",f"Probleme de nom de programme Luva_cert.exe")
	input()
...
contient_creation = terme_creation.lower() in ini_filename.lower()
terme_extraction = "extraction"
contient_extraction = terme_extraction.lower() in ini_filename.lower()
terme_keystore = "keystore"
contient_keystore = terme_keystore.lower() in ini_filename.lower()
terme_cacert = "cacerts"
contient_cacert = terme_cacert.lower() in ini_filename.lower()

try:
	if not contient_creation and not contient_extraction and not contient_keystore and not contient_cacert:
