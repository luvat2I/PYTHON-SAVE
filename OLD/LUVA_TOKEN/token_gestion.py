...
def token_gestion_microsoft(TENANT, CLIENT_ID, CLIENT_SECRET, GRANT_TYPE, SCOPE, USERNAME, PASSWORD ,TIMEOUT_TIME , VERIF_SSL):
	error = False
	ID_APP = "XCMIC"
	...
	result = requests.post(TOKEN_URL, data=data, headers=headers, timeout=TIMEOUT_TIME, verify=VERIF_SSL)
	print (result.json())
	if not error :
		try:
			return {
