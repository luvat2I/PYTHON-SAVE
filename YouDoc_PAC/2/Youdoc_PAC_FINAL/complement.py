...
def solr_event_echoue(SOLR_LOG,log_sorl,log_console,log_file,CATEGORIE_EVENT,CODE_EVENT,SUB_EVENT,MESSAGE_EVENT) :

    if SOLR_LOG :
        TYPE_EVENT = "Final"
        objectTypeDescription_EVENT = "Final"
...
def solr_event_cours(SOLR_LOG,log_sorl,log_console,log_file,CATEGORIE_EVENT,SUB_EVENT,CODE_EVENT) :
    if SOLR_LOG :
        TYPE_EVENT = "Final"
        objectTypeDescription_EVENT = "Final"
        
        MESSAGE_EVENT = "Lancement du service de Final"
        RESULT_SOLR = log_sorl.en_cours(CATEGORIE_EVENT,CODE_EVENT,SUB_EVENT,TYPE_EVENT,objectTypeDescription_EVENT,MESSAGE_EVENT)
        if RESULT_SOLR["error"] :
            log_console.error(f"Enregistrement event solr - {RESULT_SOLR["return"]}")
            log_file.error(f"Enregistrement event solr - {RESULT_SOLR["return"]}")

def solr_event_traite(SOLR_LOG,log_sorl,log_console,log_file,CATEGORIE_EVENT,CODE_EVENT,SUB_EVENT,MESSAGE_EVENT) :
