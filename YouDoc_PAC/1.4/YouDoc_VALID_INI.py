...
try:	
	...
	print(f"INFO > db_database : {parameter_file}")
except Exception as e:
    print(f"ERROR > L'option 'parameter_file' est manquante dans le fichier 'config.ini': {e}")
    input("Appuyez sur une touche pour quitter...")
    exit(1)  # Quitte l'application avec un code d'erreur
...
try:	
    ...
    print(f"ERROR > L'option 'parameter_file' a provoqué une erreur: {e}")
    input("Appuyez sur une touche pour quitter...")
    exit(1)  # Quitte l'application avec un code d'erreur
